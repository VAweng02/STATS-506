...
print(t_test_2_3)
```
All three t-tests show statistically significant differences in phenol levels between the wine classes.The largest difference is observed between Class 1 and Class 3, while Class 1 and Class 2 and Class 2 and Class 3 have smaller, but still significant differences. Overall, these results suggest that the phenol levels are significantly different across all three wine classes.
