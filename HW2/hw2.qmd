...
# using emmip()
emmip(model, eng_horsepower ~ eng_torque, at = list(eng_horsepower = c(150, 350, 550), eng_torque = c(150, 260, 420)))

# using interact_plot()
interact_plot(model, pred = eng_torque, modx = eng_horsepower,at = list (id_year = 2010), data = gasoline_cars)
```
...
X <- model.matrix(fuel_highway_mpg ~ eng_torque*eng_horsepower + dim_length + dim_width + dim_height + as.factor(id_year), data = gasoline_cars)
